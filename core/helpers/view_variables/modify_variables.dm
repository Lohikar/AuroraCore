...
/client/proc/mod_list(var/list/L, atom/O, original_name, objectvar)
	...
	if(!assoc)
		names = L.Copy()
		sortTim(names, /proc/cmp_text_asc)
	...
	if(marked_datum)
		class = input("What kind of variable?","Variable Type",default) as null|anything in list("text",
			"num","type","reference","mob reference", "icon","file","list","edit referenced object","restore to default","marked datum ([marked_datum.type])", "DELETE FROM LIST")
	else
		class = input("What kind of variable?","Variable Type",default) as null|anything in list("text",
