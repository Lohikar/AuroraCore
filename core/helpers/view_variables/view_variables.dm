...
/var/list/view_variables_dont_expand = list("overlays", "underlays", "vars", "screen")
...
/client/verb/cmd_debug_variables(datum/D in world)
	set category = "Debug"
	set name = "View Variables"

	debug_variables(D)

/client/proc/debug_variables(datum/D)
	if(!D)
		return
	...
	usr << browse_rsc('core/helpers/view_variables/view_variables.js', "view_variables.js")
				...
				<table width='100%'><tr>
					<td width='50%'>
						...
						<div align='center'>
							...
							[marked_datum == D ? "<br/><font size='1' color='red'><b>Marked Object</b></font>" : ""]
						</div>
					</td>
					<td width='50%'>
						<div align='center'>
...
/proc/make_view_variables_var_list(datum/D)
	...
	sortTim(variables, /proc/cmp_text_asc)
